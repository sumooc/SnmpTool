...
public class SnmpAgent {
    ...
    private static final int AES128_INDEX = 0;
    private static final int AES192_INDEX = 1;
    private static final int AES256_INDEX = 2;
    private static final int DES_INDEX = 3;
    private static final int _3DES_INDEX = 4;
    private static final int MD5_INDEX = 0;
    private static final int SHA_INDEX = 1;
    private static final int SHA224_INDEX = 2;
    private static final int SHA256_INDEX = 3;
    private static final int SHA384_INDEX = 4;
    private static final int SHA512_INDEX = 5;
    ...
    public Object getSnmpResult(SnmpParameter snmpParameter) throws Exception {
        ...
        if (snmpParameter.getVersion() == SnmpConstants.version3) { // snmp v3
            ...
            if (StringUtils.isNotBlank(snmpParameter.getAuthPassphrase())
                ...
                if (snmpParameter.getAuthProtocol() == MD5_INDEX) {
                    authProtocol = AuthMD5.ID;
                } else if (snmpParameter.getAuthProtocol() == SHA_INDEX) {
                    authProtocol = AuthSHA.ID;
                } else if (snmpParameter.getAuthProtocol() == SHA224_INDEX) {
                    authProtocol = AuthHMAC128SHA224.ID;
                } else if (snmpParameter.getAuthProtocol() == SHA256_INDEX) {
                    authProtocol = AuthHMAC192SHA256.ID;
                } else if (snmpParameter.getAuthProtocol() == SHA384_INDEX) {
                    authProtocol = AuthHMAC256SHA384.ID;
                } else if (snmpParameter.getAuthProtocol() == SHA512_INDEX) {
            ...
            if (StringUtils.isNotBlank(snmpParameter.getPrivacyPassphrase())
                ...
                if (snmpParameter.getPrivacyProtocol() == DES_INDEX) {
                    privacyProtocol = PrivDES.ID;
                } else if (snmpParameter.getPrivacyProtocol() == _3DES_INDEX) {
                    privacyProtocol = Priv3DES.ID;
                } else if (snmpParameter.getPrivacyProtocol() == AES128_INDEX) {
                    privacyProtocol = PrivAES128.ID;
                } else if (snmpParameter.getPrivacyProtocol() == AES192_INDEX) {
                    privacyProtocol = PrivAES192.ID;
                } else if (snmpParameter.getPrivacyProtocol() == AES256_INDEX) {
